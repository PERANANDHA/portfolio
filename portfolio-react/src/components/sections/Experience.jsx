      ...
      >
        ...
        <div className="timeline">
          ...
          <div className="timeline-item glass-card">
            ...
            <a href="/NEXYUGA INTERSHIP.pdf" target="_blank" rel="noreferrer" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem', marginTop: '15px' }}>
          ...
          <div className="timeline-item glass-card">
            ...
            <a href="/INFOSYS INTERSHIP.pdf" target="_blank" rel="noreferrer" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem', marginTop: '15px' }}>
              <i className="fas fa-file-pdf"></i> View Certificate
            </a>
          </div>
          ...
          <div className="timeline-item glass-card">
            ...
            <a href="/AICTE INTERSHIP.pdf" target="_blank" rel="noreferrer" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.9rem', marginTop: '15px' }}>
              <i className="fas fa-file-pdf"></i> View Certificate
            </a>
          </div>
