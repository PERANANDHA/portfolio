      ...
      >
        ...
        <div className="certs-grid">
          ...
          <div className="glass-card cert-card">
            ...
            <p>Oracle</p>
            <a href="/Oracle Cloud Infrastructure 2025 Certified DevOps Professional.pdf" target="_blank" rel="noreferrer" className="btn btn-secondary" style={{ padding: '0.5rem 1rem', fontSize: '0.85rem', marginTop: '15px' }}>
              <i className="fas fa-file-pdf"></i> View Certificate
            </a>
          </div>
          ...
          <div className="glass-card cert-card">
            ...
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginTop: '15px', justifyContent: 'center' }}>
              ...
              <a href="/Design & Implementation of Human-Computer Interfaces.pdf" target="_blank" rel="noreferrer" className="btn btn-secondary" style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem' }}>
