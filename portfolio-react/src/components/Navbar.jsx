...
const Navbar = () => {
  ...
  const toggleTheme = () => {
    ...
    // Dispatch custom event so the 3D scene can listen for theme changes
      ...
      <div className="nav-content">
        ...
        <div 
          ...
          style={{ 
            ...
            background: mobileMenuOpen ? 'rgba(6, 9, 19, 0.95)' : undefined,
            padding: mobileMenuOpen ? '20px 0' : undefined,
            gap: mobileMenuOpen ? '20px' : undefined,
            borderBottom: mobileMenuOpen ? '1px solid var(--card-border)' : undefined,
          }}
        >
